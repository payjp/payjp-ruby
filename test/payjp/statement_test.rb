...
module Payjp
  class StatementTest < Test::Unit::TestCase
    ...
    should "create_download_urls should be callable" do
      @mock.expects(:get).never
      @mock.expects(:post).once.returns(test_response({ :object => "statement_download_url", :url => 'https://pay.jp/_/statements/8f9ec721bc734dbcxxxxxxxxxxxxxxxx', :expires => 1476676539 }))
      c = Payjp::Statement.new('st_test')
      response = c.create_download_urls()
